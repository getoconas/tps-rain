...
print("Las 50 palabras mas frecuentes son...")
...
print("\nLas 50 palabras más frecuentes (basado en Stemming):")
...
print("\n Las 50 palabras más frecuentes (basado en lematización):")
...
# Función auxiliar para obtener el PoS tag para la lematización
...
print("\n Lematización indicando el PoS para los verbos (50 más frecuentes):")
...
table_data = []
tagged_words_first_30 = pos_tag(words_filtered[:30])
